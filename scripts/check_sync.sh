...
Examples:
  ./check_sync.sh --public-rpc https://rpc.morphl2.io
  ./check_sync.sh --compose-service geth --public-rpc https://rpc.morphl2.io
  CONTAINER=geth-1 PUBLIC_RPC=https://rpc.morphl2.io ./check_sync.sh
EOF
}
